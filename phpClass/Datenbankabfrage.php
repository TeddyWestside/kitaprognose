...
class Datenbankabfrage
{
  ...
  {
      $sql_AnzahlKinder = $GLOBALS['conn']->query("SELECT Stadtteil_Bez, (sum(5bis6m) + sum(5bis6w) + sum(4bis5m) + sum(4bis5w) + sum(3bis4m) + sum(3bis4w)) as SummeKinder FROM Kitaprognose.AlterStadtteil WHERE Bezirk_Bez NOT LIKE 'Gesamtstadt' AND Stichtag LIKE '2015-12-31' GROUP BY Stadtteil_Bez;");
  ...
  {
      $sql_AnzahlKinder = $GLOBALS['conn']->query("SELECT Stadtteil_Bez, (sum(2bis3m) + sum(2bis3w) + sum(4bis5m) + sum(4bis5w) + sum(3bis4m) + sum(3bis4w)) as SummeKinder FROM Kitaprognose.AlterStadtteil WHERE Bezirk_Bez NOT LIKE 'Gesamtstadt' AND Stichtag LIKE '2015-12-31' GROUP BY Stadtteil_Bez;");
      return $sql_AnzahlKinder;
  }
  ...
  {
      $sql_AnzahlKinder = $GLOBALS['conn']->query("SELECT Stadtteil_Bez, (sum(2bis3m) + sum(2bis3w) + sum(1bis2m) + sum(1bis2w) + sum(3bis4m) + sum(3bis4w)) as SummeKinder FROM Kitaprognose.AlterStadtteil WHERE Bezirk_Bez NOT LIKE 'Gesamtstadt' AND Stichtag LIKE '2015-12-31' GROUP BY Stadtteil_Bez;");
      return $sql_AnzahlKinder;
  }
  ...
  {
      $sql_AnzahlKinder = $GLOBALS['conn']->query("SELECT Stadtteil_Bez, (sum(2bis3m) + sum(2bis3w) + sum(1bis2m) + sum(1bis2w) + sum(0bis1m) + sum(0bis1w)) as SummeKinder FROM Kitaprognose.AlterStadtteil WHERE Bezirk_Bez NOT LIKE 'Gesamtstadt' AND Stichtag LIKE '2015-12-31' GROUP BY Stadtteil_Bez;");
      return $sql_AnzahlKinder;
  }
}
